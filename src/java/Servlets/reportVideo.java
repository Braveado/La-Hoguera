 ...
 * @author Nelson
 */
@WebServlet(name = "reportVideo", urlPatterns = {"/reportVideo"})
public class reportVideo extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try
        {
            ...
            out.print("<title>Reportar Video - La Hoguera</title>");
            out.print("</head>");
            out.print("<body>");
            ...
            if(reports.AddReport(vid, profid, userid, reason))
            {
                out.println("<section class=\"modificarusuario\">");
                out.println("<ul>");
                out.println("<li class=\"imagen\">");
                out.println("<img src=\"css/img/Report.png\" height=\"60\">");
                out.println("</li>");
                ...
                out.println("</li>");
                out.println("<li id=\"pregunta\">");
                out.println("<h3>Reportado Exitosamente</h3>");
                out.println("</li>");
                out.println("<li>");
                out.println("<a href=\"main.jsp\">");
                out.println("<input type=\"submit\" value=\"Pagina Principal\">");
                out.println("</a>");
                out.println("</li>");
                out.println("</ul>");
                out.println("</section>");                
            ...
            else
            {
                ...
                out.println("alert('Error al reportar video');");
