 ...
 * @author Nelson
 */
@WebServlet(name = "delVideoBan", urlPatterns = {"/delVideoBan"})
public class delVideoBan extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try
        {
            ...
            if(reports.DelVideoBan(vid))
            {
                ...
                out.println("<h3>Bloqueo del Video</h3>");
                out.println("</li>");   
                out.println("<li id=\"pregunta\">");
