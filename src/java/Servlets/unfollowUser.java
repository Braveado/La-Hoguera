...
public class unfollowUser extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try
        {
            ...
            out.print("<title>Dejar de Seguir - La Hoguera</title>");
            out.print("</head>");
            out.print("<body>");
            ...
            if(res.next())
            {
                ...
                if(follows.DelFollow(nameid, userid))
                {
                    ...
                    out.println("</li>");
                    out.println("<li id=\"pregunta\">");
                    out.println("<h3>Dejado de Seguir Exitosamente</h3>");
                    out.println("</li>");
                    out.println("<li>");
                ...
                else
                {
                    ...
                    out.println("alert('Error al dejar de seguir al usuario');");
