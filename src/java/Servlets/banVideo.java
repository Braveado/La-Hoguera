 ...
 * @author Nelson
 */
@WebServlet(name = "banVideo", urlPatterns = {"/banVideo"})
public class banVideo extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try
        {
            ...
            out.print("<title>Bloquear Video - La Hoguera</title>");
            out.print("</head>");
            out.print("<body>");
            ...
            if(reports.BanVideo(vid, reason) && reports.DelVideoReports(vid))
            {
                ...
                out.println("</li>");
                out.println("<li id=\"pregunta\">");
                out.println("<h3>Bloqueado Exitosamente</h3>");
                out.println("</li>");
                out.println("<li>");
            ...
            else
            {
                ...
                out.println("alert('Error al bloquear el video');");
