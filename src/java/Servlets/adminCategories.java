 ...
 * @author Nelson
 */
@WebServlet(name = "adminCategories", urlPatterns = {"/adminCategories"})
public class adminCategories extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try
        {
            ...
            String c1color = request.getParameter("C1COLOR");
            Integer c1order = Integer.parseInt(request.getParameter("C1ORDER"));
            String c2color = request.getParameter("C2COLOR");
            Integer c2order = Integer.parseInt(request.getParameter("C2ORDER"));
            String c3color = request.getParameter("C3COLOR");
            Integer c3order = Integer.parseInt(request.getParameter("C3ORDER"));
            String c4color = request.getParameter("C4COLOR");
            Integer c4order = Integer.parseInt(request.getParameter("C4ORDER"));
            String c5color = request.getParameter("C5COLOR");
            Integer c5order = Integer.parseInt(request.getParameter("C5ORDER"));

            if(categories.ModCategories(c1color, c1order, c2color, c2order, c3color, c3order, c4color, c4order, c5color, c5order))
            {
                ...
                out.println("<h3>Categorias modificadas exitosamente</h3>");
                out.println("</li>");
                out.println("<li>");
            ...
            else
            {
                ...
                out.println("alert('Error al modificar categorias');");
