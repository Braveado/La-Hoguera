 ...
 * @author Nelson
 */
@WebServlet(name = "delVideo", urlPatterns = {"/delVideo"})
public class delVideo extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try
        {
            ...
            out.print("<title>Eliminar Video - La Hoguera</title>");
            out.print("</head>");
            out.print("<body>");
            ...
            if(sharedContent.DelVideo(videoid))
            {
            ...
            else
            {
                ...
                out.println("alert('Error al eliminar video');");
