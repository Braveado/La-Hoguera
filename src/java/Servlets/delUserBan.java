 ...
 * @author Nelson
 */
@WebServlet(name = "delUserBan", urlPatterns = {"/delUserBan"})
public class delUserBan extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try
        {
            ...
            out.print("<title>Eliminar Bloqueo - La Hoguera</title>");
            out.print("</head>");
            out.print("<body>");
            ...
            if(reports.DelUserBan(profid))
            {
                ...
                out.println("<h3>Bloqueo del Usuario</h3>");
                out.println("</li>");   
                out.println("<li id=\"pregunta\">");
                out.println("<h3>"+profname+"</h3>");
                out.println("</li>");
                out.println("<li id=\"pregunta\">");
            ...
            else
            {
                ...
                out.println("alert('Error al eliminar el bloqueo');");
                out.println("location='adminBans.jsp';");
                out.println("</script>");
            }
