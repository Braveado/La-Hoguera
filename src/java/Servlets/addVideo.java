...
public class addVideo extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try
        {
            ...
            out.print("<title>Agregar Video - La Hoguera</title>");
            out.print("</head>");
            out.print("<body>");
            ...
            String hashedname = login.generateHash(newname);
            ...
            if(sharedContent.AddVideo(userid, title, description, category1, category2, category3, imageStream, restricted, hashedname))
            {
                ...
                out.println("</li>");
                out.println("<li id=\"pregunta\">");
                out.println("<h3>Agregado Exitosamente</h3>");
                out.println("</li>");
                out.println("<li>");
            ...
            else
            {
                ...
                out.println("alert('Error al agregar video');");
