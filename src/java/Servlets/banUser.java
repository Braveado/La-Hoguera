...
public class banUser extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try
        {
            ...
            out.print("<title>Bloquear Usuario - La Hoguera</title>");
            out.print("</head>");
            out.print("<body>");
            ...
            if(reports.BanUser(profid, perma, expires, reason, details) && reports.DelUserReports(profid))
            {
